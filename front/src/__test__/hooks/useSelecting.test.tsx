...
describe('useSelecting', () => {
  ...
  it('should have a hanlers function', () => {
    // handler 체크
  ...
  it('should have a values as false', () => {
    // Value check
  ...
  it('should update the value when FirstHandler is called', () => {
    // setter 기능 체크
    act(() => {
      inputHandler[1]();
    });
  ...
  it('should update the value when SecondHandler is called', () => {
    // setter 기능 체크
    act(() => {
      inputHandler[3]();
    });
  ...
  it('should update the value when ThirdHandler is called', () => {
    // setter 기능 체크
    act(() => {
      inputHandler[5]();
    });
