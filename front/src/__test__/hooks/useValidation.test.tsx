...
describe('useInput', ()=>{
    ...
    it('should have a handler function', ()=>{  // handler 체크 
        expect(inputHandler[1]).toBeInstanceOf(Function);
    });
     
    it('should have a correct validation function', ()=>{  // setter 체크 
    ...
    it('should update the value when handler is called',()=>{ // handler 기능 체크 
    ...
    it('should update the value when handler is called',()=>{ // handler 기능 체크 2
