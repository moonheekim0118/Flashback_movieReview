...
describe('review reducer', () => {
  ...
  it('should request load my reviews', () => {
    // 리뷰 리스트 로딩 리퀘스트
  ...
  it('should succeed load my reviews', () => {
    // 리뷰 리스트 로딩 성공
  ...
  it('should fail load my reviews', () => {
    // 리뷰 리스트 로딩 실패
  ...
  it('should request add my reviews', () => {
    // 리뷰 추가 리퀘스트
  ...
  it('should succeed add my reviews', () => {
    // 리뷰 추가 성공
  ...
  it('should request remove my reviews', () => {
    // 리뷰 삭제 리퀘스트
  ...
  it('should succeed remove my reviews', () => {
    // 리뷰 삭제 성공
  ...
  it('should fail remove my reviews', () => {
    // 리뷰 삭제 실패
  ...
  it('should request update my reviews', () => {
    // 리뷰 수정 리퀘스트
  ...
  it('should succeed update my reviews', () => {
    // 리뷰 수정 성공
  ...
  it('should fails update my reviews', () => {
    // 리뷰 수정 실패
  ...
  it('should request load my single review', () => {
    // 리뷰 1개 로딩 리퀘스트
  ...
  it('should succeed load my single review', () => {
    // 리뷰 1개 로딩 성공
  ...
  it('should fail load my single review', () => {
    // 리뷰 1개 로딩 실패
