...
describe('alert reducer',()=> {
    ...
    it('should request login', ()=>{ // 로그인 리퀘스트 
    ...
    it('should succeed login', ()=>{ // 로그인 성공 
    ...
    it('should request logout', ()=>{ // 로그아웃 리퀘스트 
    ...
    it('should succeed logout', ()=>{ // 로그아웃 성공 
    ...
    it('should request signUp', ()=>{ // 회원가입 리퀘스트 
    ...
    it('should succeed signUp', ()=>{ // 회원가입 성공 
    ...
    it('should request load my Info', ()=>{ // 내정보 로딩 리퀘스트 
    ...
    it('should succeed load my Info', ()=>{ // 내정보 로딩 성공 
    ...
    it('should fail load my Info', ()=>{ // 내정보 로딩 실패 
    ...
    it('should request update nickname', ()=>{ // 닉네임 변경 리퀘스트 
    ...
    it('should succeed update nickname', ()=>{ // 닉네임 변경 성공 
    ...
    it('should fail update nickname', ()=>{ // 닉네임 변경 실패 
    ...
    it('should request update profilePic', ()=>{ // 프로필 사진 변경 리퀘스트 
    ...
    it('should succeed update profilePic', ()=>{ // 프로필 사진 변경 성공 
    ...
    it('should fail update profilePic', ()=>{ // 프로필 사진 변경 실패 
    ...
    it('should request add favorite Movie', ()=>{ // 인생영화 등록 리퀘스트 
    ...
    it('should succeed add favorite Movie', ()=>{  // 인생영화 등록 성공 
    ...
    it('should fail add favorite Movie', ()=>{  // 인생영화 등록 실패 
    ...
    it('should request load favorite Movie', ()=>{  // 인생영화 로딩 리퀘스트
    ...
    it('should succeed load favorite Movie', ()=>{  // 인생영화 로딩  성공 
    ...
    it('should fail load favorite Movie', ()=>{ // 인생영화 로딩 실패 
    ...
    it('should request remove favorite Movie', ()=>{  // 인생영화 삭제 리퀘스트 
    ...
    it('should succeed remove favorite Movie', ()=>{ // 인생영화 삭제 성공
    ...
    it('should fail remove favorite Movie', ()=>{ // 인생영화 삭제 실패 
